...
// Checking if a value is a number with isFinite
...
const randomInt = (min, man) =>
  Math.trunc(Math.random() * (man - min) + 1) + min
...
console.log(3445804823984592375984658764872356934750936796398256n)
console.log(BigInt(344580482398459))

// Operations
console.log(10000n + 10000n)
console.log(123434379568398021473957490n * 1279438259427038403729n)

const huge = 233472987924028401232n
const num = 23
...
// 2.
console.log(new Date('Aug 31 2022 11:02:06'))
